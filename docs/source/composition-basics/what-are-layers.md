...
![A diagram depicting independent layers building up to an aggregate scene.](../../images/Layers.png)
...
![Python examples for Layers](../../images/layer_Python.webm)
